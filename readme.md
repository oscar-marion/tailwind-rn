...
You can specify a path to your tailwind configuration with the `-i` flag, as well as an output path for your generated json file with the `-o` flag.

```
$ npx create-tailwind-rn -i path/to/tailwind.config.js -o path/to/styles.json
```
